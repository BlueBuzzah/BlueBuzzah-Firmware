...
class BatteryStatus:
    ...
    def __str__(self):
        ...
        return "{:.2f}V ({}%, {})".format(self.voltage, self.percentage, self.status)
...
class SessionInfo:
    ...
    def __str__(self):
        """String representation for logging."""
        return "Session {}: {}, {}s/{}s, {}".format(self.session_id, self.profile_name, self.elapsed_sec, self.duration_sec, self.state)
